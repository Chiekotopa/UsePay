...
public class Produits implements Serializable {
   private static final long serialVersionUID = 1L;
    ...
    @ManyToMany()
    @JoinTable(name = "PRODUITS_GALERY")
    private Collection<Galery> galery= new ArrayList<>(); ;
    ...
    public Collection<Galery> getGalery() {
        return galery;
    }

    public void setGalery(Collection<Galery> galery) {
        this.galery = galery;
    }
