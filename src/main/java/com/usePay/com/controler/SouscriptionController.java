...
public class SouscriptionController {
    ...
    @PostMapping("saveSouscription/{username}")
    public Object saveSouscription(@RequestBody Souscription souscription,@PathVariable(value = "username")String username) {
        HashMap map = new HashMap();
        ...
        try {
             Users userClient=userRepository.findUserByUsername(username);
            souscription.setUser(userClient);
            ...
            Users userCommercial = userRepository.findUserByUsername(souscription.getUser().getUserCreator());
            commercialStory.setUser(userCommercial);
            commercialStory.setTransactionType("Souscription");
            commercialStory.setTransactionDate(LocalDateTime.now());
            commercialStory.setNewBalance(souscription.getVersement() + userCommercial.getSolde());
            commercialStory.setOldBalance(userCommercial.getSolde());
    ...
    public Object creditClient(@RequestBody Souscription souscription) {
        ...
        try {
            ...
            Users commercialUser = userRepository.findUserByUsername(souscription.getUser().getUserCreator());
